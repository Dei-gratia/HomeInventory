...
public class HomeInventory  extends JFrame{
    ...
    public HomeInventory() {
        ...
        //newButton.setIcon(new ImageIcon(Class.class.getResource("/resources/new.gif")));
        ImageIcon imageIcon = new ImageIcon(Class.class.getResource("/resources/new.gif"));
        //Image image = imageIcon.getImage();
        //Image newing = image.getScaledInstance(40,25, java.awt.Image.SCALE_SMOOTH);
        //imageIcon =new ImageIcon(newing);
        newButton.setIcon(scaleImage(imageIcon,60,20));
        ...
        ImageIcon deleteIcon = new ImageIcon(Class.class.getResource("/resources/delete.gif"));
        deleteButton.setIcon(scaleImage(deleteIcon,60,20));
        ...
        ImageIcon saveIcon = new ImageIcon(Class.class.getResource("/resources/save.gif"));
        saveButton.setIcon(scaleImage(saveIcon,60,20));
        ...
        inventoryToolBar.addSeparator();
        ImageIcon previousIcon = new ImageIcon(Class.class.getResource("/resources/previous.gif"));
        previousButton.setIcon(scaleImage(previousIcon,60,20));
        ...
        ImageIcon nextIcon = new ImageIcon(Class.class.getResource("/resources/next.gif"));
        nextButton.setIcon(scaleImage(nextIcon,60,20));
        ...
        inventoryToolBar.addSeparator();
        ImageIcon printIcon = new ImageIcon(Class.class.getResource("/resources/print.gif"));
        printButton.setIcon(scaleImage(printIcon,60,20));
        ...
        try
        {
           ...
           // String st = inputFile.readLine().trim();
           // numberEntries = Integer.parseInt(st);
        ...
        if (locationComboBox.getItemCount() != 0)
            ...
            for (int i = 0; i < locationComboBox.getItemCount(); i++)
            {
                if(locationComboBox.getSelectedItem().toString().
                        equals(locationComboBox.getItemAt(i).toString()))
                {
